...
def test_mined_block_difficulty_limits_at_a():
    last_block = Block(
        time.time_ns(),
        'test_last_hash',
        'test_hash',
...
def test_is_valid_bad_proff_of_work(last_block, block):
    block.hash = 'fff'
...
def test_is_vald_block_jumped_difficulty(last_block, block):
...
def test_is_valid_block_bad_block_hash(last_block, block):
    block.hash = '00000000000000bbbbbbaaaaabc'
