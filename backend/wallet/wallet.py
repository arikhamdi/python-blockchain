...
class Wallet:
    ...
    def sign(self, data):
        """
        Generate a signature based on the daa using the local private key.
        """
    ...
    def calculate_balance(blockchain, address):
        """
        Calculate the alance of the given address considering the transaction
        data within the blockchain

        The balance is found by adding the output values that belong to the 
        address since the moset recent transaction by that address
        """
